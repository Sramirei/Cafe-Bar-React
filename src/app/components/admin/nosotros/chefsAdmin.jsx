...
const url = "https://cafecito-backend.herokuapp.com/api/nosotros/empleado/"; //url de la api 

class ChefsAdmin extends Component {
  ...
  seleccionEmpleado = (empleado) => {
    this.setState({
      ...
      form: {
        ...
        foto: empleado.foto,
        instagram: empleado.instagram,
        youtube: empleado.youtube,
        twitter: empleado.twitter,
      ...
      <div className="head-admin">
        <div className="tabla-resposive">
              ...
              {this.state.data.map(empleado => {
                return (
                  <tr key={empleado.id}>
                    ...
                    <td>{empleado.cargo.slice(0, 15)}...</td>
                    <td>
                      <img className="preview-imagen" src={empleado.foto ? empleado.foto : "https://firebasestorage.googleapis.com/v0/b/cafecito-ff329.appspot.com/o/nosotros-chefs%2Fsin-enlace.jpg?alt=media&token=8c95f969-2225-4894-8cd3-d01c2cc73280"} alt="" />
                    </td>
                    <td>{empleado.instagram.slice(8, 17)}...</td>
                    <td>{empleado.youtube.slice(8, 17)}...</td>
                    <td>{empleado.twitter.slice(8, 17)}...</td>
                    <td>{empleado.facebook.slice(8, 17)}...</td>
                    <td>
                      ...
                      {"   "}
                      <button className="btn btn-danger" onClick={() => { this.seleccionEmpleado(empleado); this.setState({ modalEliminar: true }) }}><i className="bi bi-trash-fill"></i></button>
          ...
          <Modal isOpen={this.state.modalInsertar} className="modal-bg">
            <ModalBody>
              <div className="form-group">
                ...
                <input className="form-control" type="text" name="apellido" apellido="apellido"
                  onChange={this.handleChange} value={form ? form.apellido : ''} />
                <br />
                <label htmlFor="cargo">Cargo</label>
                <input className="form-control" type="text" name="cargo" cargo="cargo"
                  onChange={this.handleChange} value={form ? form.cargo : ''} />
                <br />
                <label htmlFor="foto">Foto</label>
                <input className="form-control" title="Recomendación (777x789)" type="text" name="foto" foto="foto"
                ...
                <input className="form-control" type="text" name="instagram" instagram="instagram"
                  onChange={this.handleChange} value={form ? form.instagram : ''} />
                <br />
                <label htmlFor="youtube">Youtube</label>
                <input className="form-control" type="text" name="youtube" youtube="youtube"
                  onChange={this.handleChange} value={form ? form.youtube : ''} />
                <br />
                <label htmlFor="twitter">Twitter</label>
                <input className="form-control" type="text" name="twitter" twitter="twitter"
                  onChange={this.handleChange} value={form ? form.twitter : ''} />
                <br />
                <label htmlFor="facebook">Facebook</label>
                <input className="form-control" type="text" name="facebook" facebook="facebook"
                  onChange={this.handleChange} value={form ? form.facebook : ''} />
                <br />
              </div>
            </ModalBody>
            <ModalFooter>
          ...
          <Modal isOpen={this.state.modalEliminar} className="modal-bg">
            <ModalBody>
              Estas seguro de eliminar esta empleado {form && form.nombre}
            </ModalBody>
            <ModalFooter>
